...
<ToolCards
  items={[
    ...
    },
    {
      ...
      description: 'Connects to an IMAP email account to automatically sort messages into folders based on rules, and to purge (archive or delete) messages matching filters like age, sender, or subject.'
    },
    {
      title: 'Ntfy Tool',
