...
<ToolCards
  items={[
    ...
    {
      title: 'Email Organizer Tool',
      link: 'https://github.com/arc53/DocsGPT/blob/main/application/agents/tools/email_organizer.py',
      description: 'Connects to an IMAP email account to automatically sort messages into folders and tag them by importance based on rules, empty out the junk/spam folder, and purge (archive or delete) messages matching filters like age, sender, or subject.'
    },
    {
      title: 'Ntfy Tool',
